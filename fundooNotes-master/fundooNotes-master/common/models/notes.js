                            ...
                            notesService.updateNote(id, { "collaborators": existingCollaberator }, userId, function (err, updateResult) {
                                if (err) {
                                    ...
                                    if (data.email != null && data.email != undefined && data.email != "") {
                                        ...
                                        var template = "<p>Hi,</p><p>" + req.currentUser.firstName + " added you as a collaraberator in his note, please <a href='http://localhost:4200/'>Click here</a> to see note</p> <p>Thanks</p>";
